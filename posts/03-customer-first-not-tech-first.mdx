...
| --- | --- |
| **Code** | Founder spent 4 yrs in a utility data-ops team; left with **10 TB** of anonymised fault logs and Python notebooks the utility granted for research. |
| **Capital** | **$450 k NSF SBIR Phase I** + **$200 k angels** — just enough runway to build the MVP and clear the utility’s cyber-security audit. |
...
*Outcome:* MVP ran on a read-only data feed, flagged six latent pole failures in Month 1 → pilot converted to a **$120 k / yr** SaaS contract after 90 days. Team now raising a **$1.5 M** seed on real ARR, not promises.
