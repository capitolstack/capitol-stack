...
| **K-12 school districts** | **\$500 M** *Renew America’s Schools* grants but zero staff capacity                                                           | Grant-to-project bundles: heat pumps or solar PPAs filed & managed   |
...
|---------------|------------------------------------------------------------------------------------------------------------------------------------|
| **Code**      | Founder spent 4 yrs in a utility data-ops team; left with a **10 TB** trove of anonymised fault logs + Python notebooks legally granted for research |
...
| **Customer**  | Municipal utility (250 k meters) signed an **LOI + \$30 k paid pilot** contingent on cyber-audit pass; target = 5 % truck-roll cut  |
