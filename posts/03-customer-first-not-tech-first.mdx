...
|--------|----------------------------------|
| **Code** | Founder spent 4 yrs in a utility data-ops team; left with a **10TB** trove of anonymised fault logs + Python notebooks legally granted for research |
| **Capital** | **$450k NSF SBIR Phase I + $200k angels** — just enough runway to prove MVP and pass the utility's cyber-security checklist |
| **Customer** | Municipal utility (250k meters) signed an **LOI + $30k paid pilot** contingent on cyber-audit pass; target = 5% truck-roll cut |
| **Community** | Private Slack of **35 grid-ops friends** supplies sample data, bug reports, candidate referrals — zero recruiter fees |

*Outcome:* MVP deployed on a read-only data feed, flagged six latent pole failures in Month 1 → pilot converted to a $120k/yr SaaS contract after 90 days. Team now raising a $1.5M seed on **real ARR**, not promises.
