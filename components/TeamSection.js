  ...
  return (
    <section className="bg-white py-28 px-6 font-inter text-center text-[#1A1A1A]">
      <div className="max-w-4xl mx-auto">
        ...
        />
        <h2 className="text-3xl font-semibold text-[#1A1A1A] mb-2">Jason Cahill</h2>
        <p className="text-md text-[#4B5563] mb-6">Founder & Managing Director</p>
        <p className="text-lg text-[#4B5563] leading-relaxed text-left max-w-3xl mx-auto">
